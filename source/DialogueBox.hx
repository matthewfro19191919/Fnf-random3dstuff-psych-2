...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		stong = Main.active3D ? PlayState3D.SONG.song.toLowerCase() : PlayState.SONG.song.toLowerCase();
	...
	function startDialogue():Void
	{
		...
		switch (curCharacter)
		{
			case 'dad':
				...
				{
					if (stong == 'senpai') portraitLeft.visible = true;
